...
<?php
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/jqvmap/backend/jqvmap.min.css">
...
<?php
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/chocolat/backend/css/chocolat.css">
<?php
...
<?php
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/bootstrap-social/bootstrap-social.css">
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/owlcarousel2/backend/assets/owl.carousel.min.css">
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/owlcarousel2/backend/assets/owl.theme.default.min.css">
<?php
}elseif ($this->uri->segment(2) == "forms_advanced_form") { ?>
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/bootstrap-daterangepicker/daterangepicker.css">
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/bootstrap-colorpicker/backend/css/bootstrap-colorpicker.min.css">
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/select2/backend/css/select2.min.css">
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/bootstrap-tagsinput/backend/bootstrap-tagsinput.css">
<?php
...
if ($this->uri->segment(2) == "layout_transparent") {
  $this->load->view('backend/_partials/layout-2');
  $this->load->view('backend/_partials/sidebar-2');
}elseif ($this->uri->segment(2) == "layout_top_navigation") {
  $this->load->view('backend/_partials/layout-3');
  $this->load->view('backend/_partials/navbar');
}elseif ($this->uri->segment(2) != null) {
  $this->load->view('backend/_partials/layout');
