<footer class="main-footer">
  ...
  <script src="<?= base_url('assets/'); ?>js/stage.js"></script>
  <?php if(($this->uri->segment(1)=="stage")&&($this->uri->segment(2)=="add")){ echo "<script src='https://maps.googleapis.com/maps/api/js?key=AIzaSyA4JBMFGxGOzT49oFyOuqCDER6yZMwDtak&&callback=myMap'></script>";}?>
