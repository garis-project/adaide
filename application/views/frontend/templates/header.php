	...
	<div class="jumbotron bg-header">
		<div class="container-xl">
			<div class="nav navbar">
				<div class="justify-content-start ">
					<div class="dropdown">
					<i class="nav-icon fas fa-bar fa-md"></i>
						<i class="glyphicon glyphicon-menu-hamburger"></i>
						<img src="<?= base_url('assets/frontend/')?>img/icons8-menu.svg" id="dropdownMenuButton" data-toggle="dropdown-menu" aria-haspopup="true" aria-expanded="false" class="position-absolut">
