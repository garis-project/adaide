...
<body class="bg-black">
	<div class="jumbotron bg-header">
		<div class="container-xl">
			...
			<!-- navbar mobile -->
			<nav class="navbar navbar-expand-lg mt-n4" id="nav-mobile">
				<a class="navbar-brand" href="<?=base_url('home')?>">
					<img src="<?= base_url('assets/frontend/')?>img/logo-putih.png" class="logo">
				</a>
				<img src="<?= base_url('assets/frontend/')?>img/icons8-menu.svg" data-toggle="modal" data-target="#menu-mobile" style="height: 20px;">
			</nav>
			...
			<div class="modal fade" id="menu-mobile" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content bg-black">
						<div class="modal-header border-bottom bg-black">
