      ...
      <div class="container mt-5">
        <div class="page-error">
          <div class="page-inner">
			...
			<?php if($ci->session->userdata('id_role')==1){ ?>
              ...
              <form>
                <div class="form-group floating-addon floating-addon-not-append">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="Search" id="url">
                    <div class="input-group-append">
                      <button type="button" class="btn btn-primary btn-lg" onclick="searchUrl()">
                        Search
                      </button>
                    </div>
                  </div>
